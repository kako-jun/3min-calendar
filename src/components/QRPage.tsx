    ...
    <div className="mx-auto max-w-6xl px-2">
      ...
      <div className="mt-2 flex flex-col gap-4 lg:flex-row lg:items-start">
        ...
        <div className="flex flex-col items-center gap-4 lg:w-1/2">
          {/* QRコード表示 */}
          <div
            className="relative flex items-center justify-center rounded p-4"
            style={{
            ...
            >
              <AnimatePresence mode="wait">
                {isValidUrl ? (
                  ...
                  >
                    <span className="text-sm">{t('qr.enterUrl')}</span>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
          ...
          {/* 安全性アピール */}
          <div
            className="w-full max-w-md rounded p-3 text-xs"
            style={{ backgroundColor: appTheme.surface, color: appTheme.textMuted }}
          >
            <p className="flex items-start gap-2">
              <FontAwesomeIcon icon={faShieldHalved} className="mt-0.5 shrink-0 text-green-500" />
